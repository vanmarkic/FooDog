...
const callTags = f => {
            ...
            //Call --- --  open function, GET-type of request, url, true-asynchronous
                        ...
                        if (this.status === 200) {
                                    ...
                                    for (let i = 0; i < data.docs.length; i++) {
                                                ...
                                                if (data.docs[i].tagForArticle.includes(id)) {
                                                            ...
                                                            article.innerHTML = `<img class="column is-half" src="${
                                data.docs[i].imgUrl
                                }" alt="dogs" />
...
<div class="artitle">
<a id="${data.docs[i]._id}" href="single.html?id=${
                                data.docs[i]._id
                                }" class="uppercase">${data.docs[i].title}</a>
</div>
...
<div class="meta">
<div class="underline">
<a class="uppercase ${data.docs[i].tagForArticle[j]}" href="#">${
              data.docs[i].tagForArticle[j]
            }</a>
</div>
</div>`;
